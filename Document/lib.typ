  ...
  #let translations = (
    en: (
      ...
      consisting_of: "submitted by",
      and_: "and",
      in_: "in",
      faculty: "Applied Mechanics",
  ...
  #let report(
    ...
    date: none,
    lang: "en",
    location: "Chennai", // possibly different?
    ...
    // FRONT PAGE
    set align(center)
    block(height: 25%, image("Graphics/logo.svg", height: 140%))
    ...
    text(18pt)[
      ...
      #course_name
      #linebreak()
      #link("https://github.com/ErinJossy/NLD_5650")[GitHub]
    ]
    v(1fr) // to bottom
    text(12pt)[ 
      #t.faculty
    ...
    bibliography("template/references.bib", title: t.references)
  }
